...
class Test_Kodlamaio:
    ...
    def test_login(self):
        ...
        WebDriverWait(self.driver,5).until(expected_conditions.visibility_of_element_located((By.XPATH,loginBtnXPath))) # defansif kodlama, her elementten önce mutlaka kullan
    ...
    #@pytest.mark.parametrize("username,password",[("standard_user","1"),("123","123")])
